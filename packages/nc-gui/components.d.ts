...
declare module '@vue/runtime-core' {
  export interface GlobalComponents {
    ...
    LazyApiClientHeaders: typeof import('~icons/la/zy-api-client-headers')['default']
    LazyApiClientParams: typeof import('~icons/la/zy-api-client-params')['default']
    LazyCellAttachmentCarousel: typeof import('~icons/la/zy-cell-attachment-carousel')['default']
    LazyCellAttachmentModal: typeof import('~icons/la/zy-cell-attachment-modal')['default']
    LazyCellText: typeof import('~icons/la/zy-cell-text')['default']
    LazyGeneralTruncateText: typeof import('~icons/la/zy-general-truncate-text')['default']
    LazyMonacoEditor: typeof import('~icons/la/zy-monaco-editor')['default']
    LazyNuxtImg: typeof import('~icons/la/zy-nuxt-img')['default']
    LazySmartsheetHeaderCell: typeof import('~icons/la/zy-smartsheet-header-cell')['default']
    LazySmartsheetHeaderVirtualCell: typeof import('~icons/la/zy-smartsheet-header-virtual-cell')['default']
    LazySmartsheetToolbarColumnFilter: typeof import('~icons/la/zy-smartsheet-toolbar-column-filter')['default']
    LazyWebhookChannelMultiSelect: typeof import('~icons/la/zy-webhook-channel-multi-select')['default']
    LazyWebhookTest: typeof import('~icons/la/zy-webhook-test')['default']
