export enum MetaTable {
  ...
  PDF_GENERATOR_VIEW = 'nc_pdf_generator_view_v2',
  PDF_GENERATOR_VIEW_COLUMNS = 'nc_pdf_generator_view_columns_v2',
  USERS = 'nc_users_v2',
  ORGS = 'nc_orgs_v2',
  TEAMS = 'nc_teams_v2',
...
export enum CacheScope {
  ...
  PDF_GENERATOR_VIEW = 'pdfGeneratorView',
  PDF_GENERATOR_VIEW_COLUMN = 'pdfGeneratorViewColumn',
  USER = 'user',
  ORGS = 'orgs',
  TEAM = 'team',
  TEAM_USER = 'teamUser',
